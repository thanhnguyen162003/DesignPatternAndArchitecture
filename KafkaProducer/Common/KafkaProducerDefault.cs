...
{
    public class KafkaProducerDefault : IKafkaProducerDefault
    {
        private readonly IConfiguration _configuration;
        private readonly IProducer<string, string> _producer;
        private readonly ILogger<KafkaProducerDefault> _logger;

        public KafkaProducerDefault(IConfiguration configuration, ILogger<KafkaProducerDefault> logger)
        {
