...
{
    public abstract class KafkaConsumerDefault<T> : BackgroundService
    {
        private readonly IConsumer<string, string> _consumer;
        private readonly IServiceProvider _serviceProvider;
        private readonly ILogger<KafkaConsumerDefault<T>> _logger;
        ...
        protected KafkaConsumerDefault(
            IConfiguration configuration,
            ILogger<KafkaConsumerDefault<T>> logger,
